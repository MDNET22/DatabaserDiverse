...
using KeysDemoDb.DataAccess.DbModels;
using KeysDemoDb.DataAccess.DbViews;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=Sur;Initial Catalog=KeysDemoDb;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<City>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Cities__3214EC07FDC7B56C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Countrie__3214EC07874A5D0C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Courses__3214EC07DA52AA85");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Students__3214EC074A03E207");
